Feature: Create multiple hotel entry
  ...
  Scenario Outline: Test to create multiple customer entry
    ...
    Examples: Test data
      ...
      | admin    | password | HMRC 3 Star Hotel  | 1, Newcastle road | James   | 080038992   | james@email.com   | James   |
      | admin    | password | HMRC 5 Star Hotel  | 2, Newcastle road | Lewis   | 080038992   | lewis@email.com   | Lewis   |
      | admin    | password | HMRC 7 Star Hotel  | 3, Newcastle road | Comfort | 080038992   | comfort@email.com | Comfort |
      | admin    | password | HMRC 10 Star Hotel | 4, Newcastle road | Nicole  | 080038992   | nicole@email.com  | Nicole  |